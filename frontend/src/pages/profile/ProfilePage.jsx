		...
		<>
			<div className='flex-[4_4_0]  border-r border-gray-700 min-h-screen '>
				...
				<div className='flex flex-col'>
					{!isLoading && !isRefetching && user && (
						<>
							...
							<div className='flex w-full border-b border-gray-700 mt-4'>
								...
								<div
									className={`flex justify-center flex-1 p-3 hover:bg-secondary transition duration-300 relative cursor-pointer ${
										feedType === "reposts" ? "" : "text-slate-500"
									}`}
								...
								<div
									className={`flex justify-center flex-1 p-3 hover:bg-secondary transition duration-300 relative cursor-pointer ${
										feedType === "bookmarks" ? "" : "text-slate-500"
									}`}
								...
								<div
									className={`flex justify-center flex-1 p-3 hover:bg-secondary transition duration-300 relative cursor-pointer ${
										feedType === "followers" ? "" : "text-slate-500"
									}`}
									onClick={() => setFeedType("followers")}
								>
									Followers
					...
					{feedType === "followers" || feedType === "following" ? (
						<UserList username={username} listType={feedType} />
					) : (
						<Posts feedType={feedType} username={username} userId={user?._id} authUser={authUser} />
					)}
				</div>
			</div>
		</>
